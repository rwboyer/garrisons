...
function brand_post_type() {
	...
	register_post_type( 'post_type_brand', $args );

}
add_action( 'init', 'brand_post_type', 0 );

// Register Custom Post Type
function closeout_post_type() {

	$labels = array(
		'name'                  => _x( 'Close Outs', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Close Out', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Close Out', 'text_domain' ),
		'name_admin_bar'        => __( 'Close Out', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Close Out', 'text_domain' ),
	...
	register_post_type( 'post_type_closeout', $args );

}
add_action( 'init', 'closeout_post_type', 0 );
...
function testimonial_post_type() {
	...
	register_post_type( 'testimonial_post_typ', $args );
...
function about_post_type() {
	...
	register_post_type( 'post_type_about', $args );
...
function resource_post_type() {
	...
	register_post_type( 'post_type_resource', $args );

}
add_action( 'init', 'resource_post_type', 0 );

// Register Custom Post Type
function trail_post_type() {
	...
	$labels = array(
		...
		'name_admin_bar'        => __( 'Trail', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
	...
	register_post_type( 'post_type_trail', $args );

}
add_action( 'init', 'trail_post_type', 0 );
